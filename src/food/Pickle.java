...
//A pickle class to create the and add the pickles on top of the burger bun.
...
public class Pickle{
	...
	public Pickle(double xPos, double yPos, double sca) {

		this.xPos = xPos;
		this.yPos = yPos;
		this.sca = sca;

		img = ImageLoader.loadImage("assets/pickle.png");
